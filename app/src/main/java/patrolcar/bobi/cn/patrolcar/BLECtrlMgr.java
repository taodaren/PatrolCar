...
import static patrolcar.bobi.cn.patrolcar.AppConstant.BLE_DEVICE_NAME;
import static patrolcar.bobi.cn.patrolcar.AppConstant.TAG_BLE;

public class BLECtrlMgr extends BaseActivity {
            ...
            AndPermission.with(this)
                    ...
                    .onDenied(new Action() {
                        ...
                        public void onAction(List<String> permissions) {
                            // 如果一直否认权限
                            if (AndPermission.hasAlwaysDeniedPermission(BLECtrlMgr.this, permissions)) {
                                // 提示用户设置
...
//                .setServiceUuids(serviceUuids)
                // 只扫描指定广播名的设备，可选
                .setDeviceName(true,BLE_DEVICE_NAME)
//                // 只扫描指定 MAC 的设备，可选
//                .setDeviceMac(mac)
    ...
    private void connBLE(final BleDevice bleDevice) {
        BleManager.getInstance().connect(bleDevice, new BleGattCallback() {
            ...
            public void onDisConnected(boolean isActiveDisConnected, BleDevice device, BluetoothGatt gatt, int status) {
                ...
                Log.i(TAG_BLE, "DEV_MAC: " + bleDevice.getMac() + " 连接后再断开: " + isActiveDisConnected);
            }
        });
    }
